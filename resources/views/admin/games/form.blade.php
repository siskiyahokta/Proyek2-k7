                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="platforms" class="form-control" required>
                                <option value="">-- Pilih Platform --</option>
                                <option value="PS4"
                                    {{ old('platforms', $game->platforms[0] ?? '') == 'PS4' ? 'selected' : '' }}>
                                    PS4
                                </option>
                                <option value="PS5"
                                    {{ old('platforms', $game->platforms[0] ?? '') == 'PS5' ? 'selected' : '' }}>
                                    PS5
                                </option>
                            </select>
                        </div>

                        <!-- GENRES, MODES, LANGUAGES -->
                        <div class="row">

                            <div class="col-md-4 mb-3">
                                <label class="form-label">Genres (pisah koma)</label>
                                <input type="text" name="genres" class="form-control"
                                       value="{{ old('genres', is_array($game->genres) ? implode(',', $game->genres) : '') }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label class="form-label">Modes (pisah koma)</label>
                                <input type="text" name="modes" class="form-control"
                                       value="{{ old('modes', is_array($game->modes) ? implode(',', $game->modes) : '') }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label class="form-label">Languages (pisah koma)</label>
                                <input type="text" name="languages" class="form-control"
                                       value="{{ old('languages', is_array($game->languages) ? implode(',', $game->languages) : '') }}">
                            </div>
                        </div>

                        <!-- RELEASE YEAR, SIZE, RATING -->
                        <div class="row">
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="size_gb" class="form-control"
                                       value="{{ old('size_gb', $game->size_gb) }}">
                            </div>
