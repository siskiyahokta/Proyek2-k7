      ...
      <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
        ...
        @auth
          @if(auth()->user()->role === 'admin')
            <li class="nav-item">
              <a class="btn btn-accent ms-lg-2" href="{{ url('/admin') }}">Admin Dashboard</a>
            </li>
          @endif
        ...
        @guest
          <li class="nav-item">
            <a class="btn btn-accent ms-lg-2" href="{{ url('/register') }}">Daftar</a>
          </li>
          <li class="nav-item">
            <a class="btn btn-outline-accent ms-lg-2" href="{{ url('/login') }}">Masuk</a>
          </li>
        @endguest
      </ul>
    </div>
